...
import { CalculateShppingRates200Response } from '../model/calculateShppingRates200Response';
import { CalculateShppingRates400Response } from '../model/calculateShppingRates400Response';
import { CalculateShppingRatesRequest } from '../model/calculateShppingRatesRequest';
...
export enum ShippingRatesV2ApiApiKeys {
}

export class ShippingRatesV2Api {
    ...
    public setApiKey(key: ShippingRatesV2ApiApiKeys, value: string) {
        (this.authentications as any)[ShippingRatesV2ApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param calculateShppingRatesRequest POST request body
     */
    public async calculateShppingRates (xPFStoreId?: string, xPFLanguage?: string, calculateShppingRatesRequest?: CalculateShppingRatesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CalculateShppingRates200Response;  }> {
        const localVarPath = this.basePath + '/v2/shipping-rates';
        ...
        localVarHeaderParams['X-PF-Language'] = ObjectSerializer.serialize(xPFLanguage, "string");
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(calculateShppingRatesRequest, "CalculateShppingRatesRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CalculateShppingRates200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "CalculateShppingRates200Response");
