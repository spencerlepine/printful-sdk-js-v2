...
import { CreateMockupGeneratorTasks200Response } from '../model/createMockupGeneratorTasks200Response';
import { GetMockupGeneratorTasks200Response } from '../model/getMockupGeneratorTasks200Response';
...
import { MockupTaskCreation } from '../model/mockupTaskCreation';
...
export enum MockupGeneratorV2ApiApiKeys {
}

export class MockupGeneratorV2Api {
    ...
    public setApiKey(key: MockupGeneratorV2ApiApiKeys, value: string) {
        (this.authentications as any)[MockupGeneratorV2ApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param mockupTaskCreation This action schedules asynchronous mockup generation tasks. In the response of this request &#x60;id&#x60; will be returned which can be used to retrieve the result of the tasks _[Retrieve mockup generator tasks](#operation/getMockupGeneratorTasks)_. In addition, the webhook event will be sent informing about the task completion, if the correct webhook has been subscribed to _[Mockup generator task finished event](#operation/mockupTaskFinished)_. You can subscribe to webhook events by using _[Set up event configuration](#operation/createWebhookEventConfiguration)_.
     */
    public async createMockupGeneratorTasks (xPFStoreId?: string, mockupTaskCreation?: MockupTaskCreation, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CreateMockupGeneratorTasks200Response;  }> {
        const localVarPath = this.basePath + '/v2/mockup-tasks';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(mockupTaskCreation, "MockupTaskCreation")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CreateMockupGeneratorTasks200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "CreateMockupGeneratorTasks200Response");
     ...
     */
    public async getMockupGeneratorTasks (id: Array<string>, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetMockupGeneratorTasks200Response;  }> {
        const localVarPath = this.basePath + '/v2/mockup-tasks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getMockupGeneratorTasks.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetMockupGeneratorTasks200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "GetMockupGeneratorTasks200Response");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
