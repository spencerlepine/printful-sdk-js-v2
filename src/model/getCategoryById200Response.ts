...
export class GetCategoryById200Response {
    'data'?: Category;
    'links'?: GetCategoryById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetCategoryById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetCategoryById200Response.attributeTypeMap;
    }
}
