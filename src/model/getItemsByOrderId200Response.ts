...
export class GetItemsByOrderId200Response {
    'data'?: Array<GetItemsByOrderId200ResponseDataInner>;
    'links'?: GetItemsByOrderId200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<GetItemsByOrderId200ResponseDataInner>"
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetItemsByOrderId200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetItemsByOrderId200Response.attributeTypeMap;
    }
}
