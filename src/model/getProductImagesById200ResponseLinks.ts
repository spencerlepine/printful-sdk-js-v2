...
* HATEOAS links
*/
export class GetProductImagesById200ResponseLinks {
    /**
    * Link to same resource
    */
    'self'?: HateoasLink2;
    'productDetails'?: GetProductImagesById200ResponseLinksProductDetails;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "GetProductImagesById200ResponseLinksProductDetails"
        }    ];

    static getAttributeTypeMap() {
        return GetProductImagesById200ResponseLinks.attributeTypeMap;
    }
}
