...
export class ConfirmOrder200Response {
    'data'?: Order;
    'links'?: ConfirmOrder200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "ConfirmOrder200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return ConfirmOrder200Response.attributeTypeMap;
    }
}
