...
export class GetProductVariantsById200Response {
    'data'?: Array<Variant>;
    'paging'?: Paging;
    'links'?: GetProductVariantsById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetProductVariantsById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetProductVariantsById200Response.attributeTypeMap;
    }
}
