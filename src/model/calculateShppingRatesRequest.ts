...
export class CalculateShppingRatesRequest {
    /**
    * The recipient data.
    */
    ...
    */
    'orderItems': Array<CalculateShppingRatesRequestOrderItemsInner>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "Array<CalculateShppingRatesRequestOrderItemsInner>"
        },
        {
            "name": "currency",
            "baseName": "currency",
    ...
    static getAttributeTypeMap() {
        return CalculateShppingRatesRequest.attributeTypeMap;
    }
}
