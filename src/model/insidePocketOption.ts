...
*/
export class InsidePocketOption {
    /**
    * Option identifier
    */
    'name': InsidePocketOption.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "InsidePocketOption.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return InsidePocketOption.attributeTypeMap;
    }
}

export namespace InsidePocketOption {
    export enum NameEnum {
        InsidePocket = <any> 'inside_pocket'
    }
}
