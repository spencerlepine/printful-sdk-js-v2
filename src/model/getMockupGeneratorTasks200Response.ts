...
export class GetMockupGeneratorTasks200Response {
    'data'?: Array<MockupGeneratorTask>;
    'paging'?: Paging;
    'links'?: GetMockupGeneratorTasks200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetMockupGeneratorTasks200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetMockupGeneratorTasks200Response.attributeTypeMap;
    }
}
