...
export class GetProductImagesById200Response {
    'data'?: Array<VariantImages>;
    'paging'?: Paging;
    'links'?: GetProductImagesById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetProductImagesById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetProductImagesById200Response.attributeTypeMap;
    }
}
