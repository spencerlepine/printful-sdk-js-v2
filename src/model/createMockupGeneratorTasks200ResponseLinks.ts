...
* HATEOAS links
*/
export class CreateMockupGeneratorTasks200ResponseLinks {
    /**
    * Link to the result of the mockups
    */
    'self'?: HateoasLink;
    ...
    static getAttributeTypeMap() {
        return CreateMockupGeneratorTasks200ResponseLinks.attributeTypeMap;
    }
}
