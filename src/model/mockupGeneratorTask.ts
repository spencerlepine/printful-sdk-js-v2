...
*/
export class MockupGeneratorTask {
    /**
    * Unique task identifier used to check status of the task and retrieve the results once the task is ready.
    */
    'id'?: number;
    /**
    * Task status:  * `completed` – Mockup Generator task was successfully processed  * `pending` – Mockup Generator task is still being processed  * `failed` – Mockup Generator task failed 
    */
    'status'?: MockupGeneratorTask.StatusEnum;
    /**
    ...
    */
    'catalogVariantMockups'?: Array<MockupGeneratorTaskCatalogVariantMockupsInner>;
    'failureReasons'?: Array<Error>;
    'links'?: MockupGeneratorTaskLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "MockupGeneratorTask.StatusEnum"
        },
        {
            "name": "catalogVariantMockups",
            "baseName": "catalog_variant_mockups",
            "type": "Array<MockupGeneratorTaskCatalogVariantMockupsInner>"
        },
        {
            "name": "failureReasons",
            "baseName": "failure_reasons",
            "type": "Array<Error>"
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "MockupGeneratorTaskLinks"
        }    ];

    static getAttributeTypeMap() {
        return MockupGeneratorTask.attributeTypeMap;
    }
}
