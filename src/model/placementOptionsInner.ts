...
export class PlacementOptionsInner {
    /**
    * Option identifier
    */
    'name': PlacementOptionsInner.NameEnum;
    /**
    * Specifies type of inside label design that should be used
    */
    'value': PlacementOptionsInner.ValueEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "PlacementOptionsInner.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
            "type": "PlacementOptionsInner.ValueEnum"
        }    ];

    static getAttributeTypeMap() {
        return PlacementOptionsInner.attributeTypeMap;
    }
}

export namespace PlacementOptionsInner {
    export enum NameEnum {
        InsideLabelType = <any> 'inside_label_type'
    }
