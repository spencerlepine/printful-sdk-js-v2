...
export class CreateMockupGeneratorTasks200Response {
    'data'?: Array<MockupGeneratorTask>;
    'links'?: CreateMockupGeneratorTasks200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<MockupGeneratorTask>"
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "CreateMockupGeneratorTasks200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return CreateMockupGeneratorTasks200Response.attributeTypeMap;
    }
}
