...
export class SellingRegionStockAvailabilityPlacementOptionAvailabilityInner {
    'name'?: string;
    ...
    static getAttributeTypeMap() {
        return SellingRegionStockAvailabilityPlacementOptionAvailabilityInner.attributeTypeMap;
    }
}
