...
export class CatalogMockupProduct {
    /**
    * Mockup product source
    */
    'source'?: string;
    /**
    * Used to specify style of mockups that should be generated. For example:   * On the hanger   * On the Male/Female model   * Flat on the table   * etc. Available mockup styles for catalog product can be found under _[Retrieve catalog product mockup styles](#operation/retrieveMockupStylesByProductId)_. 
    */
    'mockupStyleIds'?: Array<number>;
    /**
    * Catalog product identifier
    */
    'catalogProductId'?: number;
    /**
    * List of catalog variant identifiers for which mockups will be generated. Variants must belong to the catalog product specified with `catalog_product_id`. Multiple variants of the same color do not count towards the daily number of files limit. Meaning that for a Red T-Shirt of (S,M) sizes we still generate only one mockup.
    */
    'catalogVariantIds'?: Array<string>;
    /**
    * Define orientation of the product (used in case of e.g. canvas). Vertical by default. For products without orientation this parameter is ignored.
    */
    'orientation'?: CatalogMockupProduct.OrientationEnum;
    /**
    ...
    */
    'productOptions'?: Array<ProductOptionsInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "mockupStyleIds",
            "baseName": "mockup_style_ids",
            "type": "Array<number>"
        },
        {
            "name": "catalogProductId",
            "baseName": "catalog_product_id",
            "type": "number"
        },
        {
        ...
        },
        {
            ...
            "type": "CatalogMockupProduct.OrientationEnum"
        },
        {
            "name": "placements",
            "baseName": "placements",
        ...
        },
        {
            ...
            "type": "Array<ProductOptionsInner>"
        }    ];

    static getAttributeTypeMap() {
        return CatalogMockupProduct.attributeTypeMap;
    }
}

export namespace CatalogMockupProduct {
