...
export class GetVariantImagesById200Response {
    'data'?: Array<VariantImages>;
    'links'?: GetVariantImagesById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetVariantImagesById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetVariantImagesById200Response.attributeTypeMap;
    }
}
