...
export class GetInvoiceByOrderId200ResponseData {
    /**
    * This property is used to describe the media type of the encoded base64 value. It is necessary to use this property when decoding the content property.
    */
    'mediaType'?: string;
    /**
    * The base64 encoded document containing the invoice.
    */
    'content'?: string;
    'links'?: GetInvoiceByOrderId200ResponseDataLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetInvoiceByOrderId200ResponseDataLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetInvoiceByOrderId200ResponseData.attributeTypeMap;
    }
}
