...
export class GetOAuthScopes401Response {
    /**
    ...
    */
    'result'?: string;
    'error'?: GetOAuthScopes401ResponseError;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "error",
            "baseName": "error",
            "type": "GetOAuthScopes401ResponseError"
        }    ];

    static getAttributeTypeMap() {
        return GetOAuthScopes401Response.attributeTypeMap;
    }
}
