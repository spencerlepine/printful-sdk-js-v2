...
export class OAuthScope {
    ...
    */
    'name': OAuthScope.NameEnum;
    /**
    * The scope value
    */
    'value': OAuthScope.ValueEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "OAuthScope.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
            "type": "OAuthScope.ValueEnum"
        }    ];

    static getAttributeTypeMap() {
        return OAuthScope.attributeTypeMap;
    }
}

export namespace OAuthScope {
    export enum NameEnum {
        OrdersOfTheAuthorizedStore = <any> 'View orders of the authorized store',
        AndManageOrdersOfTheAuthorizedStore = <any> 'View and manage orders of the authorized store',
        StoreProducts = <any> 'View store products',
        AndManageStoreProducts = <any> 'View and manage store products',
        StoreFiles = <any> 'View store files',
        AndManageStoreFiles = <any> 'View and manage store files',
        StoreWebhooks = <any> 'View store webhooks',
        AndManageStoreWebhooks = <any> 'View and manage store webhooks'
    }
    export enum ValueEnum {
        OrdersRead = <any> 'orders/read',
        Orders = <any> 'orders',
        SyncProductsRead = <any> 'sync_products/read',
        SyncProducts = <any> 'sync_products',
        FileLibraryRead = <any> 'file_library/read',
        FileLibrary = <any> 'file_library',
        WebhooksRead = <any> 'webhooks/read',
        WebhooksRead2 = <any> 'webhooks/read'
    }
}
