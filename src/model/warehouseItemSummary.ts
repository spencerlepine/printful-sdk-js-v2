...
*/
export class WarehouseItemSummary {
    /**
    * Item ID
    */
    'id'?: number;
    ...
    * The item type
    */
    'type'?: WarehouseItemSummary.TypeEnum;
    /**
    * Item source
    */
    'source'?: WarehouseItemSummary.SourceEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "source",
            "baseName": "source",
            "type": "WarehouseItemSummary.SourceEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return WarehouseItemSummary.attributeTypeMap;
    }
}
