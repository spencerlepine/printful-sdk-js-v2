...
export class GetProductStockAvailabilityById403Response {
    /**
    ...
    */
    'result'?: string;
    'error'?: GetProductStockAvailabilityById403ResponseError;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "error",
            "baseName": "error",
            "type": "GetProductStockAvailabilityById403ResponseError"
        }    ];

    static getAttributeTypeMap() {
        return GetProductStockAvailabilityById403Response.attributeTypeMap;
    }
}
