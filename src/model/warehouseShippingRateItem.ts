...
export class WarehouseShippingRateItem {
    /**
    * Warehouse source
    */
    'source': WarehouseShippingRateItem.SourceEnum;
    /**
    * Item quantity
    */
    'quantity': number;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "source",
            "baseName": "source",
            "type": "WarehouseShippingRateItem.SourceEnum"
        },
        {
            "name": "quantity",
            "baseName": "quantity",
    ...
    static getAttributeTypeMap() {
        return WarehouseShippingRateItem.attributeTypeMap;
    }
}
