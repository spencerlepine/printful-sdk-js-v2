...
export class CalculateShppingRates200ResponseDataInner {
    /**
    * Shipping method ID
    */
    'shipping': string;
    /**
    * A descriptive name of the shipping method including an estimate that can be displayed to customers
    */
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "min_delivery_days",
            "type": "number"
        },
        {
            "name": "maxDeliveryDays",
            "baseName": "max_delivery_days",
            "type": "number"
        },
        {
            "name": "minDeliveryDate",
            "baseName": "min_delivery_date",
            "type": "string"
        },
        {
            "name": "maxDeliveryDate",
            "baseName": "max_delivery_date",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return CalculateShppingRates200ResponseDataInner.attributeTypeMap;
    }
}
