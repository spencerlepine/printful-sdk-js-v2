...
*/
export class StitchColorOption {
    /**
    * Option identifier
    */
    'name': StitchColorOption.NameEnum;
    /**
    * Option value
    */
    'value': string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "StitchColorOption.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return StitchColorOption.attributeTypeMap;
    }
}

export namespace StitchColorOption {
    export enum NameEnum {
        StitchColor = <any> 'stitch_color'
    }
}
