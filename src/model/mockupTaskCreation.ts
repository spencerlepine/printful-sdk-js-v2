...
export class MockupTaskCreation {
    /**
    * Generated file format. PNG will have a transparent background, JPG will have a smaller file size.
    */
    'format'?: MockupTaskCreation.FormatEnum;
    'products'?: Array<MockupProduct>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "format",
            "baseName": "format",
            "type": "MockupTaskCreation.FormatEnum"
        },
        {
            "name": "products",
            "baseName": "products",
            "type": "Array<MockupProduct>"
        }    ];

    static getAttributeTypeMap() {
        return MockupTaskCreation.attributeTypeMap;
    }
}
