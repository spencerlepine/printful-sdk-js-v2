...
export class WebhookCreated {
    /**
    * Webhook URL (HTTPS-only) that will receive store\'s event notifications if no URL is set for the event.
    */
    'defaultUrl'?: string | null;
    /**
    * Date-time indicating when the configuration will expire. The default value is `null` meaning it won\'t expire.
    */
    'expiresAt'?: Date | null;
    /**
    * Array of enabled webhook event configurations
    */
    'events'?: Array<EventConfigurationResponse>;
    /**
    * Public key used to identify the specific settings.
    */
    'publicKey'?: string;
    /**
    * Secret key used to generate and verify the event signature. Visible only once upon configuration set-up.
    */
    'secretKey'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "events",
            "baseName": "events",
            "type": "Array<EventConfigurationResponse>"
        },
        {
            "name": "publicKey",
            "baseName": "public_key",
    ...
    static getAttributeTypeMap() {
        return WebhookCreated.attributeTypeMap;
    }
}
