...
export class GetCountries200Response {
    'data'?: Array<Country>;
    'paging'?: Paging;
    'links'?: GetCountries200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetCountries200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetCountries200Response.attributeTypeMap;
    }
}
