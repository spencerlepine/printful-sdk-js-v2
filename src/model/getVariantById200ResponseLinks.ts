...
* HATEOAS links
*/
export class GetVariantById200ResponseLinks {
    /**
    * Link to same resource
    */
    'self'?: HateoasLink2;
    /**
    * Link all variants associated with this variants product
    */
    'productVariants'?: HateoasLink2;
    /**
    * Link product data associated with this variant
    */
    'productDetails'?: HateoasLink2;
    /**
    * Link to variant prices
    */
    'variantPrices'?: HateoasLink2;
    /**
    * Link to variant images
    */
    'variantImages'?: HateoasLink2;
    /**
    * Link to variant stock availability endpoint
    */
    'availability'?: HateoasLink2;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "variantPrices",
            "baseName": "variant_prices",
            "type": "HateoasLink2"
        },
        {
            "name": "variantImages",
            "baseName": "variant_images",
            "type": "HateoasLink2"
        },
        {
            "name": "availability",
    ...
    static getAttributeTypeMap() {
        return GetVariantById200ResponseLinks.attributeTypeMap;
    }
}
