...
export class CatalogShippingRateItem {
    /**
    * Catalog source
    */
    'source': CatalogShippingRateItem.SourceEnum;
    /**
    * Item quantity
    */
    'quantity': number;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "source",
            "baseName": "source",
            "type": "CatalogShippingRateItem.SourceEnum"
        },
        {
            "name": "quantity",
            "baseName": "quantity",
    ...
    static getAttributeTypeMap() {
        return CatalogShippingRateItem.attributeTypeMap;
    }
}
