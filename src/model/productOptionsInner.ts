...
export class ProductOptionsInner {
    /**
    * Option identifier
    */
    'name': ProductOptionsInner.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "ProductOptionsInner.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return ProductOptionsInner.attributeTypeMap;
    }
}

export namespace ProductOptionsInner {
