...
export class GetVariantById200Response {
    'data'?: Variant;
    'links'?: GetVariantById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetVariantById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetVariantById200Response.attributeTypeMap;
    }
}
