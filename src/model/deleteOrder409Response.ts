...
export class DeleteOrder409Response {
    /**
    * Response status code `409`
    */
    'code'?: number;
    /**
    * An error message describing a conflict between the request and the current state of the resource.
    */
    'result'?: string;
    'error'?: DeleteOrder409ResponseError;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "error",
            "baseName": "error",
            "type": "DeleteOrder409ResponseError"
        }    ];

    static getAttributeTypeMap() {
        return DeleteOrder409Response.attributeTypeMap;
    }
}
