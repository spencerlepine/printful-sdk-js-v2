...
export class OrderSummary {
    ...
    */
    'orderItems'?: Array<OrderSummaryOrderItemsInner>;
    'links'?: OrderSummaryLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "retailCosts",
            "baseName": "retail_costs",
            "type": "RetailCosts"
        },
        {
            "name": "orderItems",
            "baseName": "order_items",
            "type": "Array<OrderSummaryOrderItemsInner>"
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "OrderSummaryLinks"
        }    ];
