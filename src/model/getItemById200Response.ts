...
export class GetItemById200Response {
    'data'?: GetItemsByOrderId200ResponseDataInner;
    'links'?: GetItemById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "GetItemsByOrderId200ResponseDataInner"
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetItemById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetItemById200Response.attributeTypeMap;
    }
}
