...
* HATEOAS links
*/
export class GetItemById200ResponseLinks {
    'self'?: GetItemById200ResponseLinksSelf;
    'order'?: GetItemById200ResponseLinksOrder;
    'allItems'?: GetItemById200ResponseLinksAllItems;
    'shipments'?: GetItemById200ResponseLinksShipments;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "self",
            "baseName": "self",
            "type": "GetItemById200ResponseLinksSelf"
        },
        {
            "name": "order",
            "baseName": "order",
            "type": "GetItemById200ResponseLinksOrder"
        },
        {
            "name": "allItems",
            "baseName": "all_items",
            "type": "GetItemById200ResponseLinksAllItems"
        },
        {
            "name": "shipments",
            "baseName": "shipments",
            "type": "GetItemById200ResponseLinksShipments"
        }    ];

    static getAttributeTypeMap() {
        return GetItemById200ResponseLinks.attributeTypeMap;
    }
}
