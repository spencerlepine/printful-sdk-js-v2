...
export class RetrieveMockupStylesByProductId401Response {
    /**
    * Actual error message
    */
    'data'?: string;
    'error'?: RetrieveMockupStylesByProductId401ResponseError;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "error",
            "baseName": "error",
            "type": "RetrieveMockupStylesByProductId401ResponseError"
        }    ];

    static getAttributeTypeMap() {
        return RetrieveMockupStylesByProductId401Response.attributeTypeMap;
    }
}
