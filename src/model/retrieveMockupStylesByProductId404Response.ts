...
export class RetrieveMockupStylesByProductId404Response {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "error",
            "baseName": "error",
            "type": "GetProductSizeGuideById404ResponseError"
        }    ];

    static getAttributeTypeMap() {
        return RetrieveMockupStylesByProductId404Response.attributeTypeMap;
    }
}
