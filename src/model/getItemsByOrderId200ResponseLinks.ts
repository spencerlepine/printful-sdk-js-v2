...
* HATEOAS links
*/
export class GetItemsByOrderId200ResponseLinks {
    /**
    ...
    */
    'last'?: HateoasLink;
    'order'?: GetItemsByOrderId200ResponseLinksOrder;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "order",
            "baseName": "order",
            "type": "GetItemsByOrderId200ResponseLinksOrder"
        }    ];

    static getAttributeTypeMap() {
        return GetItemsByOrderId200ResponseLinks.attributeTypeMap;
    }
}
