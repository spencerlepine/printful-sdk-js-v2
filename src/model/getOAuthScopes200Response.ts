...
export class GetOAuthScopes200Response {
    'data'?: Array<OAuthScope>;
    'links'?: GetOAuthScopes200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetOAuthScopes200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetOAuthScopes200Response.attributeTypeMap;
    }
}
