...
export class GetProductPricesById200Response {
    'data'?: ProductPrices;
    'paging'?: Paging;
    'links'?: GetProductPricesById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetProductPricesById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetProductPricesById200Response.attributeTypeMap;
    }
}
