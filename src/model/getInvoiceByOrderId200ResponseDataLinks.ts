...
* HATEOAS links
*/
export class GetInvoiceByOrderId200ResponseDataLinks {
    'self'?: GetInvoiceByOrderId200ResponseDataLinksSelf;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "self",
            "baseName": "self",
            "type": "GetInvoiceByOrderId200ResponseDataLinksSelf"
        },
        {
            "name": "order",
            "baseName": "order",
    ...
    static getAttributeTypeMap() {
        return GetInvoiceByOrderId200ResponseDataLinks.attributeTypeMap;
    }
}
