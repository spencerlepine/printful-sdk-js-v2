...
export class MockupProduct {
    ...
    */
    ...
    /**
    * List of catalog variant identifiers for which mockups will be generated. Variants must be defined in the product template specified with `product_template_id`. Multiple variants of the same color do not count towards the daily number of files limit. Meaning that for a Red T-Shirt of (S,M) sizes we still generate only one mockup.
    */
    ...
    */
    'orientation'?: MockupProduct.OrientationEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "MockupProduct.OrientationEnum"
        },
        {
            "name": "placements",
            "baseName": "placements",
        ...
        },
        {
            ...
            "baseName": "product_template_id",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return MockupProduct.attributeTypeMap;
    }
}

export namespace MockupProduct {
