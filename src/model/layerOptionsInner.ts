...
export class LayerOptionsInner {
    /**
    * Option identifier
    */
    'name': LayerOptionsInner.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "LayerOptionsInner.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return LayerOptionsInner.attributeTypeMap;
    }
}

export namespace LayerOptionsInner {
