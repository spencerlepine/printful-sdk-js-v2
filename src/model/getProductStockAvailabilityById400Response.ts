...
export class GetProductStockAvailabilityById400Response {
    /**
    ...
    */
    'result'?: string;
    'error'?: GetProductStockAvailabilityById400ResponseError;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "error",
            "baseName": "error",
            "type": "GetProductStockAvailabilityById400ResponseError"
        }    ];

    static getAttributeTypeMap() {
        return GetProductStockAvailabilityById400Response.attributeTypeMap;
    }
}
