...
*/
export class InsideLabelTypeOption {
    /**
    * Option identifier
    */
    'name': InsideLabelTypeOption.NameEnum;
    /**
    * Specifies type of inside label design that should be used
    */
    'value': InsideLabelTypeOption.ValueEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "InsideLabelTypeOption.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
            "type": "InsideLabelTypeOption.ValueEnum"
        }    ];

    static getAttributeTypeMap() {
        return InsideLabelTypeOption.attributeTypeMap;
    }
}
