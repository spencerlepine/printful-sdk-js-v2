...
export class TechniqueStockAvailability {
    'technique'?: TechniqueEnum;
    /**
    * List of selling regions with stock availability
    */
    'sellingRegions'?: Array<SellingRegionStockAvailability>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "sellingRegions",
            "baseName": "selling_regions",
            "type": "Array<SellingRegionStockAvailability>"
        }    ];

    static getAttributeTypeMap() {
        return TechniqueStockAvailability.attributeTypeMap;
    }
}
