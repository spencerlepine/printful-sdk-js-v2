...
* HATEOAS links
*/
export class GetVariantImagesById200ResponseLinks {
    'self'?: GetVariantImagesById200ResponseLinksSelf;
    'variantDetails'?: GetVariantImagesById200ResponseLinksVariantDetails;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "self",
            "baseName": "self",
            "type": "GetVariantImagesById200ResponseLinksSelf"
        },
        {
            "name": "variantDetails",
            "baseName": "variant_details",
            "type": "GetVariantImagesById200ResponseLinksVariantDetails"
        }    ];

    static getAttributeTypeMap() {
        return GetVariantImagesById200ResponseLinks.attributeTypeMap;
    }
}
