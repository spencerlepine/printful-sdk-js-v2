...
*/
export class ThreadColorsOption {
    /**
    * Option identifier
    */
    'name': ThreadColorsOption.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "ThreadColorsOption.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return ThreadColorsOption.attributeTypeMap;
    }
}

export namespace ThreadColorsOption {
    export enum NameEnum {
        ThreadColors = <any> 'thread_colors'
    }
}
