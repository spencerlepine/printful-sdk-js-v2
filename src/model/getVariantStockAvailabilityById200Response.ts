...
export class GetVariantStockAvailabilityById200Response {
    ...
    */
    ...
    'links'?: GetVariantStockAvailabilityById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetVariantStockAvailabilityById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetVariantStockAvailabilityById200Response.attributeTypeMap;
    }
}
