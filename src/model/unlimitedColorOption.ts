...
*/
export class UnlimitedColorOption {
    /**
    * Option identifier
    */
    'name': UnlimitedColorOption.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "UnlimitedColorOption.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return UnlimitedColorOption.attributeTypeMap;
    }
}

export namespace UnlimitedColorOption {
    export enum NameEnum {
        UnlimitedColor = <any> 'unlimited_color'
    }
}
