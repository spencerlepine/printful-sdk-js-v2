...
export class ShipmentLinks {
    'self'?: ShipmentLinksSelf;
    'order'?: ShipmentLinksOrder;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "self",
            "baseName": "self",
            "type": "ShipmentLinksSelf"
        },
        {
            "name": "order",
            "baseName": "order",
            "type": "ShipmentLinksOrder"
        }    ];

    static getAttributeTypeMap() {
        return ShipmentLinks.attributeTypeMap;
    }
}
