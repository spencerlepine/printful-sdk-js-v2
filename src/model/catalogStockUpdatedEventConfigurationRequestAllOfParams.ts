...
export class CatalogStockUpdatedEventConfigurationRequestAllOfParams {
    /**
    * Param name.
    */
    'name'?: CatalogStockUpdatedEventConfigurationRequestAllOfParams.NameEnum;
    /**
    * Param value - list of product data.
    */
    'value'?: Array<ProductData>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "CatalogStockUpdatedEventConfigurationRequestAllOfParams.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return CatalogStockUpdatedEventConfigurationRequestAllOfParams.attributeTypeMap;
    }
}

export namespace CatalogStockUpdatedEventConfigurationRequestAllOfParams {
