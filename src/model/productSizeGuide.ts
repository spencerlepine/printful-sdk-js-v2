...
export class ProductSizeGuide {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "availableSizes",
            "baseName": "available_sizes",
            "type": "Array<string>"
        },
        {
            "name": "sizeTables",
            "baseName": "size_tables",
            "type": "Array<SizeTable>"
        }    ];

    static getAttributeTypeMap() {
        return ProductSizeGuide.attributeTypeMap;
    }
}
