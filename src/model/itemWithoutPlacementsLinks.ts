...
* HATEOAS links
*/
export class ItemWithoutPlacementsLinks {
    'self'?: ItemWithoutPlacementsLinksSelf;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "self",
            "baseName": "self",
            "type": "ItemWithoutPlacementsLinksSelf"
        }    ];

    static getAttributeTypeMap() {
        return ItemWithoutPlacementsLinks.attributeTypeMap;
    }
}
