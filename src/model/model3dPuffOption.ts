...
*/
export class Model3dPuffOption {
    /**
    * Option identifier
    */
    'name': Model3dPuffOption.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "Model3dPuffOption.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return Model3dPuffOption.attributeTypeMap;
    }
}

export namespace Model3dPuffOption {
