...
export class GetCategoriesByProductId200Response {
    'data'?: Array<Category>;
    'paging'?: Paging;
    'links'?: GetCategoriesByProductId200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetCategoriesByProductId200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetCategoriesByProductId200Response.attributeTypeMap;
    }
}
