...
export class CalculateShppingRatesRequestOrderItemsInner {
    /**
    * Warehouse source
    */
    'source': CalculateShppingRatesRequestOrderItemsInner.SourceEnum;
    /**
    * Item quantity
    */
    'quantity': number;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "source",
            "baseName": "source",
            "type": "CalculateShppingRatesRequestOrderItemsInner.SourceEnum"
        },
        {
            "name": "quantity",
            "baseName": "quantity",
        ...
        {
            "name": "warehouseVariantId",
            "baseName": "warehouse_variant_id",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return CalculateShppingRatesRequestOrderItemsInner.attributeTypeMap;
    }
}

export namespace CalculateShppingRatesRequestOrderItemsInner {
