...
export class ApprovalSheetWebhookFile {
    'confirmHash'?: string;
    'submittedDesign'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "confirmHash",
            "baseName": "confirm_hash",
            "type": "string"
        },
        {
            "name": "submittedDesign",
            "baseName": "submitted_design",
            "type": "string"
        },
        {
            "name": "recommendedDesign",
            "baseName": "recommended_design",
            "type": "string"
        },
        {
            "name": "approvalSheet",
            "baseName": "approval_sheet",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return ApprovalSheetWebhookFile.attributeTypeMap;
    }
}
