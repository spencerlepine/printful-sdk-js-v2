...
export class MockupStyles {
    ...
    */
    'dpi'?: number;
    /**
    * A list of available mockup styles for example:   * On the hanger   * On the Male/Female model   * Flat on the table   * etc.
    */
    'mockupStyles'?: Array<MockupStylesMockupStylesInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "mockupStyles",
            "baseName": "mockup_styles",
            "type": "Array<MockupStylesMockupStylesInner>"
        }    ];

    static getAttributeTypeMap() {
        return MockupStyles.attributeTypeMap;
    }
}
