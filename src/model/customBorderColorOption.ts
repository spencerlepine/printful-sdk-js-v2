...
*/
export class CustomBorderColorOption {
    /**
    * Option identifier
    */
    'name': CustomBorderColorOption.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "CustomBorderColorOption.NameEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return CustomBorderColorOption.attributeTypeMap;
    }
}

export namespace CustomBorderColorOption {
    export enum NameEnum {
        CustomBorderColor = <any> 'custom_border_color'
    }
}
