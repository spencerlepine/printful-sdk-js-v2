...
export class GetVariantPricesById200Response {
    'data'?: VariantPrices;
    'links'?: GetVariantPricesById200ResponseLinks;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "links",
            "baseName": "_links",
            "type": "GetVariantPricesById200ResponseLinks"
        }    ];

    static getAttributeTypeMap() {
        return GetVariantPricesById200Response.attributeTypeMap;
    }
}
