...
export class WebhookShipmentData {
    /**
    * Shipment\'s ID
    */
    'id'?: number;
    ...
    */
    'status'?: string;
    /**
    * ID of the store associated with the shipment
    */
    'storeId'?: number;
    /**
    ...
    */
    'shipDate'?: string;
    /**
    * Date-time of when the shipment was sent
    */
    'shippedAt'?: Date;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return WebhookShipmentData.attributeTypeMap;
    }
}
