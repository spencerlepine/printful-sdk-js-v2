...
export class CreateOrderRequestOrderItemsInner {
    /**
    * Catalog source
    */
    'source': CreateOrderRequestOrderItemsInner.SourceEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "source",
            "baseName": "source",
            "type": "CreateOrderRequestOrderItemsInner.SourceEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return CreateOrderRequestOrderItemsInner.attributeTypeMap;
    }
}

export namespace CreateOrderRequestOrderItemsInner {
