...
export class GetInvoiceByOrderId200Response {
    'data'?: GetInvoiceByOrderId200ResponseData;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "GetInvoiceByOrderId200ResponseData"
        }    ];

    static getAttributeTypeMap() {
        return GetInvoiceByOrderId200Response.attributeTypeMap;
    }
}
