...
export class CalculateShppingRates200Response {
    'data': Array<CalculateShppingRates200ResponseDataInner>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<CalculateShppingRates200ResponseDataInner>"
        }    ];

    static getAttributeTypeMap() {
        return CalculateShppingRates200Response.attributeTypeMap;
    }
}
